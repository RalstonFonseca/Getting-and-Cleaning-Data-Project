...
# Create a file tidy_data1.txt on working directory
write.table(tidy_data1, "tidy_data1.txt", row.names = FALSE, quote = FALSE)
...
# Create a file tidy_data1.txt on working directory
write.table(tidy_data2, "tidy_data2.txt", row.names = FALSE, quote = FALSE)
